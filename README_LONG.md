# Movie Annotator v0.0.1
### based on OM-images and the videoBOOKs concept

This implementation is a simple Angular-Flask web application skeleton project with following key 
features:
...
#### Make and debug docker containers

* `docker-compose build`
* `docker-compose up`
* `docker exec -it bibbox-movie-analyzer-flask  /bin/bash`
* `main app` [http://127.0.0.1:8077](http://127.0.0.1:8077)
* `adminer` [http://127.0.0.1:8078](http://127.0.0.1:8078), U:postgres, P:postgres, DB:users_dev 
* `celery montor` [http://127.0.0.1:8079](http://127.0.0.1:8079)
* `docker restart bibbox-movie-analyzer-celery` (when the signature of a task changes)
...
### client
This directory holds the frontend Angular code.
